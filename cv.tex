...
\begin{center}
  \textbf{\Huge \scshape Igor Polyakov} \\ \vspace{3pt}
    ...
    $|$
    \faMapMarker \hspace{.5pt} \href{https://www.google.com/maps/place/Bogazici+University+North+Campus/@41.0863067,29.0441352,15z/data=!4m5!3m4!1s0x0:0x9d2497b07c8edb2f!8m2!3d41.0863067!4d29.0441352}{Saint Petersburg, Russia}
\end{center}
...
\section{Education}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeEducationHeading
      ...
      {Automation of technological processes and production (computer vision);   \textbf{GPA: 3.62/4.00}}{Sep 2010 \textbf{--} Jul 2015}
    \resumeSubheading
      {Institute of Strength Physics and Materials Science (ISPMS) SB RAS
      % \normalfont{(Admission rate: 0.85\%)}
      }{Tomsk, Russia}
      {High School Diploma;   \textbf{GPA: 97.03/100}}{Sep 2015 \textbf{--} Jan 2017}
